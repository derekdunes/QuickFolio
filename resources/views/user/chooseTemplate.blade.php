    ...
    <section class="auth-section login-section text-center py-5">
        <div class="container">
            ...
            <div class="mx-auto shadow p-5 rounded">
                ...
                <h2 class="auth-heading text-center mb-5">Choose Your Portfolio Theme</h2>
                                      ...
                                      <div class="card-body">
                                        <h5 class="card-title mb-3">
                                          <span class="theme-icon-holder card-icon-holder mr-2">
                                             ...
                                             <span class=""><input type="radio" name="template" value="{{ $template->id }}" style="margin-right: 10px">{{ $template->name }}</span>
                                        </h5>
                                        <div class="card-text">
