        ...
        <div class="page-content py-5">
            <div class="container-fluid">
                <ul class="features-tab nav nav-pills justify-content-center" id="features-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="feature-tab-1" data-toggle="tab" href="#feature-1" role="tab" aria-controls="feature-1" aria-selected="true"><i class="fas fa-shapes mr-2 d-none d-lg-inline-block"></i><span>Profile</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="feature-tab-2" data-toggle="tab" href="#feature-2" role="tab" aria-controls="feature-2" aria-selected="false"><i class="fas fa-laptop-code mr-2 d-none d-lg-inline-block"></i>Technologies</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="feature-tab-3" data-toggle="tab" href="#feature-3" role="tab" aria-controls="feature-3" aria-selected="false"><i class="fas fa-laptop-code mr-2 d-none d-lg-inline-block"></i>Projects</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="feature-tab-4" data-toggle="tab" href="#feature-4" role="tab" aria-controls="feature-4" aria-selected="false"><i class="fas fa-laptop-code mr-2 d-none d-lg-inline-block"></i>Templates</a>
                    </li>
                    @if(Auth::user()->id == 1)
                        <li class="nav-item">
                            <a class="nav-link" id="feature-tab-5" data-toggle="tab" href="#feature-5" role="tab" aria-controls="feature-5" aria-selected="false"><i class="fas fa-laptop-code mr-2 d-none d-lg-inline-block"></i>Users</a>
                        </li>
                    @endif
                    <li class="nav-item">
                        <a class="nav-link" id="feature-tab-6" data-toggle="tab" href="#feature-6" role="tab" aria-controls="feature-6" aria-selected="false"><i class="fas fa-laptop-code mr-2 d-none d-lg-inline-block"></i>Jobs (Coming Soon)</a>
                    </li>
                </ul>
            </div><!--//container-fluid-->
            <div class="container">
                <div class="features-tab-content tab-content" id="features-tab-content">
                                    ...
                                    <section class="auth-section login-section text-center py-5">
                                        <div class="container">   
                                            ...
                                            <div class="mx-auto shadow p-5 rounded">
                                                ...
                                                <h2 class="auth-heading text-center mb-5">Portfolio Stacks</h2>
                                                ...
                                                <div class="auth-form-container text-left mx-auto">
                                                                    ...
                                                                    <div class="card-body">
                                                                      ...
                                                                      <div class="card-text">
                                                                         ...
                                                                         <label class="form-label">Level Of Expertise</label>
                                                                          <select name="" class="form-control custom-select" style="padding-top: 10px; padding-bottom: 10px" disabled>
                                                                            
                                                                            @foreach($levels as $level)
                                                                                @if($stack->pivot->level == $level->id)
                                                                          ...
                                                                          <label class="form-label">Years Of Experience</label> <br>
                                                                              <input style="width: 100%" type="number" value="{{ $stack->pivot->years }}" name="" min="1" max="50" disabled>                                        
                                                                      </div>
                                                                    </div><!--//card-body-->
                                                                  </div><!--//card-->
                                                                </div><!--//col-->
                                                    ...
                                                    <div class="text-center">
                                                        <a href="{{ route('selectStack')}}">
                                                            <button type="submit" class="btn btn-primary btn-block theme-btn mx-auto">Edit Stacks</button>
                                                        </a>
                                                    </div>
                    ...
                    <div class="feature-3-pane tab-pane fade py-5" id="feature-3" role="tabpanel" aria-labelledby="feature-tab-3">
                        <div class="umbrella-layout">
                            <div class="item pb-5">
                    ...
                    <div class="feature-4-pane tab-pane fade py-5" id="feature-4" role="tabpanel" aria-labelledby="feature-tab-4">
                        <div class="umbrella-layout">
                            <div class="item pb-5">
                                <main class="p-0 theme-bg-light">    
                                    ...
                                    <section class="auth-section login-section text-center py-5">
                                        <div class="container">   
                                            ...
                                            <div class="mx-auto shadow p-5 rounded">
                                                ...
                                                <h2 class="auth-heading text-center mb-5">Change Your Portfolio Theme</h2>

                                                <div class="auth-form-container text-left mx-auto">
                                                    <form class="auth-form login-form" method="POST" action="{{ route('updateTemplate', Auth::user()->id) }}">
                                                                  ...
                                                                  <div class="col-12 col-lg-4 py-3">
                                                                    <div class="card shadow-sm">
                                                                      <div class="card-body">
                                                                        <h5 class="card-title mb-3">
                                                                          <span class="theme-icon-holder card-icon-holder mr-2">
                                                                              <img class="" style="width: 100%; height: 100%" src="{{ url(Config::get('image.theme_folder') . '/' . $template->image) }}">
                                                                            </span><!--//card-icon-holder-->
                                                                             <span class="">
                                                                                @if($template->id == Auth::user()->template_id)
                                                                                    <input type="radio" name="template" value="{{ $template->id }}" style="margin-right: 10px" checked>{{ $template->name }}</span>
                                                                                @else
                                                                                    <input type="radio" name="template" value="{{ $template->id }}" style="margin-right: 10px">{{ $template->name }}</span>
                                                                                @endif
                                                                        </h5>
                                                                        <div class="card-text">
                                                                          {{ $template->requirement }} <br>  @if($template->plan->id == 1) <span class="badge badge-success">{{ $template->plan->name }} Theme</span> @else <span class="badge badge-warning">{{ $template->plan->name }} Theme</span> @endif

                                                                          <br>

                                                                          <div><a href="{{ route('preview', $template->id) }}" target="_blank">Preview Theme</a></div>

                                                                          @if(Auth::user()->id == 1)
                                                                            <div><a href="{{ route('template.edit', $template->id) }}" target="_blank">Edit Theme</a></div>
                                                                            <div><a href="{{ route('template.destroy', $template->id) }}" target="_blank">Delete Theme</a></div>
                                                                          @endif
                                                        ...
                                                        <div class="text-center">
                                                            <a href="{{ route('selectTemplate') }}">
                                                            <button type="submit" class="btn btn-primary btn-block theme-btn mx-auto">Change Theme</button></a>
                                                        </div>
                                                        ...
                                                        @if(Auth::user()->id == 1)
                                                            ...
                                                            <div class="text-center">
                                                                ...
                                                                <button type="submit" class="btn btn-primary btn-block theme-btn mx-auto">Create New Theme</button></a>
                                                            </div>
                                                        @endif
                    ...
                    <div class="feature-5-pane tab-pane fade py-5" id="feature-5" role="tabpanel" aria-labelledby="feature-tab-5">
                        <div class="umbrella-layout">
                            <div class="item pb-5">
                                <h3 class="heading text-center mb-4">
                                    List of Paid Users
                    ...
                    <div class="feature-6-pane tab-pane fade show active py-5" id="feature-6" role="tabpanel" aria-labelledby="feature-tab-6">
    ...
    @else
                ...
                <section class="cta-section text-center py-5 theme-bg-dark position-relative">
                    ...
                    <div class="container">
                        ...
                        <div class="section-intro text-white mb-3 single-col-max mx-auto">QuickFolio makes it super easy to get your portfolio and projects online quickly, so you can start selling yourself online in no Time.</div>
                        <div class="pt-3 text-center">
                            <a class="btn btn-light" href="{{ route('user.edit', Auth::user()->id) }}">Get Started<i class="fas fa-arrow-alt-circle-right ml-2"></i></a>
                        </div>
                    </div>
                </section><!--//cta-section-->
